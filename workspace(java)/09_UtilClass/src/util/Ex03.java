 ...
 *   - Calendar 클래스에는 날짜와 시간을 계산하는데 꼭 필요한 메서드나 상수로 구성이 되어있음
...
public class Ex03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("52주 중 현재 주: " + week + "주");
		...
		if(am_pm == 0) {
			System.out.println("현재 시간은 오전 " + hour + "시" + minute + "분" + second + "초");
		}else {
			System.out.println("현재 시간은 오후 " + hour + "시" + minute + "분" + second + "초");
		}
		
		//2. 24시간제를 이용하는 방법
		int hours = cal.get(Calendar.HOUR_OF_DAY);
		
		System.out.println("현재 시간은 오후 " + hours + "시" + minute + "분" + second + "초");
	}
