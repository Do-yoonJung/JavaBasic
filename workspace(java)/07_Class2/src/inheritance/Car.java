 ...
 * -실세계에서의 상속은 상위 객체의 속성이 하위 객체에 물려져서 하위 객체가 상위 객체의 속성을 모두 가지는 개념이다.
 * -자바에서의 상속은 자식클래스가 부모클래스의 속성을 물려받고 기능을 추가하여 확장(extends)하는 개념이다.
 * -상속은 슈퍼클래스의 필드와 메서드를 물려 받아서 코드를 재사용함으로써, 코드 작성에 드는 시간과 비용을 줄일 수 있다.
 ...
 * -상속의 장점은 클래스의 수정을 최소화시킬 수 있는 장점이 있다.
 ...
 * -주의사항) 부모클래스는 반드시 기존에 미리 정의되어있어야 함.
 */
